...
\titleformat{\subsection}[block]{}{%
	\begin{tcolorbox}
		[
		enhanced,%枠の描画に TikZ を利用するときなどのオプション
...
\begin{prop}{{\cite[Exercise 1.2.8(d)]{DS}, \cite[pp.~19]{1-2-3}, %\cite[pp.~19, Proposition 6]{1-2-3}の証明中, 
